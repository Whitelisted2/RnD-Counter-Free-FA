...
#ifndef YY_YY_REGEXPARSER_TAB_H_INCLUDED
# define YY_YY_REGEXPARSER_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
#endif /* !YY_YY_REGEXPARSER_TAB_H_INCLUDED  */
...
#line 26 "regexParser.y"
	...
	{
		if((yyvsp[0].str)[i]=='#') printf("%d",charcount);
		else printf("%c",(yyvsp[0].str)[i]);
	}
	printf(";\n");
	free((yyvsp[0].str));
	charcount=0;
...
#line 39 "regexParser.y"
	...
	strcpy((yyval.str),"RatExpOnnLetters(#,\"union\",[\0");
...
#line 78 "regexParser.y"
	...
	{
		ind=ind*26+((yyvsp[-1].str)[i]-96);
	}
	if(ind>charcount) charcount=ind;
	(yyval.str)=malloc(29*sizeof(char));
	strcpy((yyval.str),"RatExpOnnLetters(#,[],[\0");
	sprintf(tr,"%d",ind);
	strcat((yyval.str),tr);
	strcat((yyval.str),"])\0");
}
